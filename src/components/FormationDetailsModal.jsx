    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl w-full max-w-lg p-8 relative shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <h2 className="text-3xl font-extrabold text-gray-900 mb-2 font-sans">
          {formation.intitule || formation.nom}
        </h2>
        <p className="text-gray-600 mb-8 text-lg leading-relaxed">
          {formation.description || formation.descriptionDetaillee || "Développez de sites et applications interactives"}
        </p>
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-100 pb-4">
            ...
            <p className="text-gray-600 text-lg">{formation.niveau || "Non spécifié"}</p>
          </div>

          <div className="border-b border-gray-100 pb-4">
            <h3 className="text-lg font-bold text-gray-900 mb-1">Nombre de places</h3>
            <p className="text-gray-600 text-lg">{formation.capacite || "12 places par classes"}</p>
          </div>

          <div className="border-b border-gray-100 pb-4">
            <h3 className="text-lg font-bold text-gray-900 mb-1">Durée</h3>
            <p className="text-gray-600 text-lg">{formation.duree || "1 jour"}</p>
          </div>

          <div className="pb-2">
            <h3 className="text-lg font-bold text-gray-900 mb-1">Prix</h3>
            <p className="text-gray-600 text-lg">{formation.prix || "200€ / session"}</p>
          </div>
        </div>
