...
public class Formateur extends Utilisateur {
    ...
    public Formateur(Long idUtilisateur, String nom, String prenom, String email, String motDePasse, String telephone, Long idFormateur, String specialite, List<Session> sessions, List<Formation> formations, List<Note> notesSaisies, List<Presence> presencesGerees) {
